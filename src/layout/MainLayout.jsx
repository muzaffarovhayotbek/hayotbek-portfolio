        ...
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 sm:flex sm:gap-2">
            <img
              src={left}
              alt="Left Icon"
              className="w-8 p-1 gap-2 cursor-pointer md:hidden" // Show on medium screens (640px-768px) and smaller
              onClick={toggleMenu} // Toggles the menu when clicked
            />
            <Link
              to="/"
          ...
          <div className="flex items-center gap-4 sm:flex sm:gap-3">
            {/* Menu for larger screens (above 768px) */}
